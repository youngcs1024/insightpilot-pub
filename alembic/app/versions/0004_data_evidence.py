"""Immutable data evidence with application ownership and idempotent turn identity."""
...
revision: str = "0004_data_evidence"
...
def upgrade() -> None:
    ...
    op.execute("REVOKE UPDATE, DELETE ON public.data_evidence FROM app_rw")


def downgrade() -> None:
    """Remove this application's snapshot table during explicit rollback."""
    op.drop_table("data_evidence")
