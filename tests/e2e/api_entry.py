...
from app.core.observability import Observation, Observability, TraceMetadata
...
class RecordingObservability(Observability):
    ...
    def begin(self, name: str, metadata: TraceMetadata, *, generation: bool = False,
              trace_id: str | None = None, parent: Observation | None = None) -> Observation:
        observation = super().begin(name, metadata, generation=generation,
